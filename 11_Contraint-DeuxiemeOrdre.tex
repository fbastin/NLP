...
Les dérivées secondes $\frac{d^2}{dt^2} f(x(0))$ déterminent si $t=0$ est un minimiseur local: si $d^T\nabla^2_{xx}L(x^*,\lambda^*)d < 0$, alors $x^*$ n'est pas un minimum local.
\end{column}
\begin{column}{0.45\textwidth}
\centering
