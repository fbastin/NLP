...
\begin{align*}
g &= \nabla f(x_k) \\
H &= \nabla^2 f(x_k) \text{ ou une approximation}\\
M &= R^TR \quad \text{(préconditionneur)}
\end{align*}
...
La troisième possibilité est que $s_k$ soit hors de la région de confiance à l'itération $k$.
